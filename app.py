...
if uploaded_file is not None:
    ...
    if "iphone" in description.lower():
        guidance = "This looks like your iphone. Keep it safe!"
    elif "wallet" in description.lower():
        guidance = "Your wallet is on the table. Do you need to use it?"
